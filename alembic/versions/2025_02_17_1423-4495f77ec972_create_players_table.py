...
Revision ID: 4495f77ec972
Revises: 
Create Date: 2025-02-17 14:23:17.325168
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_characterclass_id'), 'characterclass', ['id'], unique=False)
    ...
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('main_attribute', sa.Enum('strength', 'dexterity', 'constitution', 'intelligence', 'wisdom', 'charisma', name='attribute'), nullable=False),
    sa.Column('secondary_attribute', sa.Enum('strength', 'dexterity', 'constitution', 'intelligence', 'wisdom', 'charisma', name='attribute'), nullable=False),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('name')
    )
    ...
    sa.ForeignKeyConstraint(['character_class_id'], ['characterclass.id'], ),
