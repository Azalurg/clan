...
def upgrade() -> None:
    ...
    op.create_index(op.f("ix_championclass_id"), "championclass", ["id"], unique=False)
    op.create_table(
        "profession",
        sa.Column("name", sqlmodel.sql.sqltypes.AutoString(), nullable=False),
        sa.Column("description", sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("champion_class_id", sa.Uuid(), nullable=True),
...
def downgrade() -> None:
    ...
    op.drop_index(op.f("ix_championclass_id"), table_name="championclass")
    op.drop_table("championclass")
    # ### end Alembic commands ###
